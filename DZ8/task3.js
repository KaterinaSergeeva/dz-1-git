export function whoIsYounger(birthDay1,birthDay2){
   ...
   // let birthDay2 = '23.08.1999';
    ...
    if (birthDay1Date < birthDay2Date) return console.log("Second is younger");
    else return console.log("First is younger");
}
